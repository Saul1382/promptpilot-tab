...
<p align="center">
  <a href="https://www.youtube.com/watch?v=gl7XjzoNPHM">
    <img src="assets/readme/promptpilot-tab-demo.jpg" width="100%" alt="PromptPilot Tab turns a rough idea into an editable five-part prompt and inserts it into an AI chat with Tab">
  </a>
</p>
...
![PromptPilot Tab creates a five-part local prompt and inserts it with Tab](assets/screenshots/01-local-five-modules.png)
...
![PromptPilot Tab AI modes, before-and-after comparison, and custom model settings](assets/screenshots/02-ai-optimization.png)
...
![PromptPilot Tab recommends templates that match the current task](assets/screenshots/03-template-recommendation.png)
...
![PromptPilot Tab community and local template libraries](assets/screenshots/04-community-local-library.png)
...
<p>
  <img src="assets/community/qq-group.jpg" alt="PromptPilot Tab QQ group QR code, group number 1106177594" width="160">
  <img src="assets/community/xiaohongshu-profile.jpg" alt="PromptPilot Tab Xiaohongshu account QR code, account 517411810" width="160">
</p>
